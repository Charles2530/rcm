    ...
    dict(
        ...
        model=dict(
            config=dict(
                ...
                tokenizer=dict(vae_pth="./model/Wan2.2-T2V-A14B/Wan2.1_VAE.pth"),
                text_encoder_path="./model/Wan2.2-T2V-A14B/models_t5_umt5-xxl-enc-bf16.pth",
                neg_embed_path="./model/Wan2.2-T2V-A14B/umT5_wan_negative_emb.pt",
